    ...
    <footer className="bg-[#111111] text-white py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-sm hover:underline">Stories and News</Link></li>
              <li><Link href="#" className="text-sm hover:underline">Investor Relations</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="#" className="text-sm hover:underline">Community Involvement</Link></li>
              <li><Link href="#" className="text-sm hover:underline">Diversity and Inclusion</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-sm hover:underline">Corporate Gift Cards</Link></li>
              <li><Link href="#" className="text-sm hover:underline">Office Coffee</Link></li>
              <li><Link href="#" className="text-sm hover:underline">Landlord Support</Link></li>
              <li><Link href="#" className="text-sm hover:underline">Suppliers</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between pt-8 border-t border-gray-700">
          ...
          <div className="space-y-4 md:space-y-0 md:flex md:space-x-6 text-sm">
